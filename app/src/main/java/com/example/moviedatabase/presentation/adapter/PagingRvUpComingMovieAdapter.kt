...
class PagingRvUpComingMovieAdapter: PagingDataAdapter<UpComingMovieItem, PagingRvUpComingMovieAdapter.ViewHolder>(
    DIFF_CALLBACK) {
    private lateinit var onItemCallback : OnitemClickCallback

    class ViewHolder(val binding : ItemMovies2Binding) : RecyclerView.ViewHolder(binding.root) {
